...
public class WxTokenUtil {
   ...
   /**
    ...
    public AccessToken getWXToken() {
        ...
        if(access_token == null || access_token.getAccessToken()==null ||access_token.getAccessToken().equals("")){
    ...
    public void clearWxToken(){
        redisService.delete(WeiXinEnum.CACHE_TYPE.CACHE_WX_ACCESS_TOKEN.name());
		XxlJobLogger.log("clearWxToken");
    }
