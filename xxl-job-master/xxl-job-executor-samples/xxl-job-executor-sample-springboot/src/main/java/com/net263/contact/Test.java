...
//    private static String url = "icontact.263.net:80/contact";
//    private static String url = "119.61.2.147:8053/contact";
//    private static String url = "itest.263.net:8053/contact";
   ...
   // @org.junit.Test
    public void testLogin() throws Exception {
        ...
        data.put("account", "asdf@eeewwe.6666");
        data.put("password", "h111111");
...
//        datas.add(Contact);
    ...
    public void testAddcontact() throws Exception {
        ...
        contactData.setCustsysid("2018071513373446700729");
        contactData.setCustgrpid("1000");
        contactData.setName("鞠英利");
        contactData.setEmail("juyingli@abc.com");
        contactData.setTelephone("13918528983");
        contactData.setTelephone1("13918528983");
...
//        datas.add(Contact);
        ...
        heard.put("token", "eyJhbGciOiJIUzI1NiJ9.eyJqdGkiOiJjb20ubmV0MjYzLmNvbnN0YW50IiwiaWF0IjoxNTQ3NTMyMjg2LCJzdWIiOiJ7XCJjaWRcIjpcIjU1NDIyNDA4MDZcIixcIm5hbWVcIjpcInRlc3RcIixcInVpZFwiOjIwMDAwMDIzMDUwN30iLCJleHAiOjE1NDc1NzU0ODZ9.ECfHvrdPcGtXimZXuxLjZVGn2Y5rG8lyuE3IVgdZTOM");
