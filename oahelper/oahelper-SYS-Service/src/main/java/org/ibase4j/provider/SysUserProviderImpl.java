...
public class SysUserProviderImpl extends BaseProviderImpl<SysUser> implements SysUserProvider {
	...
	public List<SysUserBean> queryPbUser(Map<String, Object> params){
		return sysUserExpandMapper.queryPbUser(params);
	}
	
	public List<String> queryDepUsers(Map<String, Object> params){
		return sysUserExpandMapper.queryDepUsers(params);
	}

	@Override
	public SysUser queryByAccount(String acount) {
		return ((SysUserMapper)getMapper()).queryByAccount(acount);
	}

	public List<SysUser> queryByCondition(Map<String, Object> params){
		return ((SysUserMapper)getMapper()).queryByCondition(params);
	}
	
	public List<SysUser> findAutityUsers(Map<String, Object> params){
		return ((SysUserMapper)getMapper()).findAutityUsers(params);
	}
}
