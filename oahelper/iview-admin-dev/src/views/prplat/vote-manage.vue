...
<template>
    <div>
        <Row :gutter="10">
            <Col span="24">
            <Card>
                <row><h2 style="margin-bottom:20px">投票管理</h2></row>
                <Row>
                    <Col span="22">
                    <span>投票名：</span>
                    <Input v-model="searchParams.voteGroupName" placeholder="投票名" style="width: 200px"/>
                    <span>发布状态：</span>
                    ...
                    <Col span="2" class="">
                    <span @click="addRecordBtn"><Button type="success"> 发起投票 </Button></span>
                    </Col>
                </Row>
        ...
        <Modal width="800" v-model="formModal" :title="editMode=='add'?'新增':'编辑'" :mask-closable="false">
            <Form ref="record" :model="record" label-position="right" :label-width="100" :rules="formValidate">
                <FormItem label="投票名" prop="voteGroupName">
                ...
                <Row>
                    <Col span="8">
                    <FormItem label="开始时间">
                        <DatePicker v-model="record.startTime" type="date" placeholder="开始时间"></DatePicker>
                    </FormItem>
                    </Col>
                    <Col span="8">
                    <FormItem label="结束时间">
                        <DatePicker v-model="record.endTime" type="date" placeholder="结束时间"></DatePicker>
                    </FormItem>
                    </Col>
                </Row>
                <FormItem label="投票描述">
        ...
        <Modal width="800" v-model="voteModal" title="编辑投票内容" :mask-closable="false">
            <div>
                <Row>
                    <Col span="16">
                    ...
                    <span style="float: right;" @click="editVote(0)">
                        <Button type="success"> 新增投票内容 </Button>
                    </span>
                    </Col>
                </Row>
        ...
        <Modal width="600" v-model="voteItemModal" title="编辑投票项" :mask-closable="false">
            <div>
                <Row>
                    <Col span="16">
                    ...
                    <span style="float: right;" @click="editVoteItem(0)">
                        <Button type="success"> 新增投票项 </Button>
                    </span>
                    </Col>
                </Row>
            </div>
        ...
        <Modal width="400" v-model="voteEditModal" title="投票内容" :mask-closable="false">
        ...
        <Modal width="400" v-model="voteItemEditModal" title="投票项" :mask-closable="false">
...
<script>
  ...
  export default {
    ...
    data () {
      return {
        ...
        columns1: [
          ...
          {
            key: 'createTime', title: '投票情况', width: 100,
            render: (h, params) => {
              return h('div', [
                h('a', {
                  domProps: {
    ...
    methods: {
      ...
      searchCancel () {
        this.searchParams = {isActivity: 'NO'}
        this.search()
      },
