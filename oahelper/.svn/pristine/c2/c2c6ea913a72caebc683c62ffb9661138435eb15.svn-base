package com.tfzq.wechat.common;
...
public class WechatUserUtil {
    ...
    public static String exchangeCode2OpenId(String code){
        ...
        try {
            ...
            //Gson gson = new Gson();
            WechatOpenId wechatOpenId = JSON.parseObject(jsonStr,WechatOpenId.class);
...
//        Gson gson = new Gson();
        ...
        try {
            wechatUser = JSON.parseObject(new String(jsonResult.getBytes("ISO-8859-1"), "UTF-8"), WechatUser.class);
            // 错误的openId
