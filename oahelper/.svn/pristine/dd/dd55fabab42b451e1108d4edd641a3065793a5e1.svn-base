    ...
    <div>
        ...
        <Modal width="800" title="查看消息" v-model="viewModal" class-name="vertical-center-modal">
            ...
            <Row style="padding-top:10px;line-height: 35px;">
                <Col span="3" style="text-align: right;font-weight: bold;">
                消息内容</Col>
                <Col span="21" style="padding-top:10px;padding-left: 20px;line-height: 20px;">
  ...
  export default {
    ...
    data () {
      return {
        ...
        //列表
        user_cols: [
          {key: 'userName', title: '用户名'}, {key: 'isReadText', title: '是否已阅'}, {key: 'isRepliedText', title: '是否回应'}
        ],
    ...
    methods: {
      ...
      initDetail (id) {
        ...
        if (id === null || id === '') {
          ...
          this.$axiosInstance({
            method: 'post',
            url: '/pr/goInformUser/selectByInform',
            data: param2
          }).then((resp) => {
