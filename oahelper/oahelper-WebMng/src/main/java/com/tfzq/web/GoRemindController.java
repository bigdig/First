						...
						for (int i = 1; i <= totalRows; i++) {
							...
							try {
								if (r.getRemindType().equals("EXPENSE_NORMAL")) {
									...
									String people = row.getCell(0).getStringCellValue();//A
									String travel = row.getCell(1).getStringCellValue();//B
									String travelDate = row.getCell(2).getStringCellValue();//C
									String travelPlane = row.getCell(3).getStringCellValue();//D
									String travelSpace = row.getCell(4).getStringCellValue();//E
									String travelTicket = row.getCell(5).getStringCellValue();//F
									String fee1 = row.getCell(6).getStringCellValue();//G
									String fee2 = row.getCell(7).getStringCellValue();//H
									String fee3 = row.getCell(8).getStringCellValue();//I
									String fee4 = row.getCell(9).getStringCellValue();//J
									String fee5 = row.getCell(10).getStringCellValue();//K
									String remark = row.getCell(11).getStringCellValue();//M
									String dept = row.getCell(12).getStringCellValue();//M
									String scheduling = row.getCell(13).getStringCellValue();//N
