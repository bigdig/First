...
public class MD5OaUtil {
	...
	private static ThreadLocal<MessageDigest> messagedigest = new ThreadLocal<MessageDigest>() {
		protected MessageDigest initialValue() {
			try {
				...
				System.err.println(MD5OaUtil.class.getName()
	...
	class R implements Runnable {
		public void run() {
			System.out.println(MD5OaUtil.getMD5String(new Random().nextFloat()
					+ ""));
		}
	}
}