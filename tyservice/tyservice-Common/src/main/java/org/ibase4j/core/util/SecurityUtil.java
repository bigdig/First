...
public final class SecurityUtil {
    ...
    public static String encryptMd5To32Str(String sourceStr, String charset) {
        String result = "";
        try {
            byte b[] = MDCoder.encodeMD5(sourceStr.getBytes(charset));//md.digest();
            int i;
    ...
    public static String encryptMd5To16Str(String sourceStr, String charset) {
        return encryptMd5To32Str(sourceStr,charset).substring(8, 24);
    }

	public static void main(String[] args) throws Exception {
//		System.out.println(encryptDes("SHJR"));
//		System.out.println(decryptDes("INzvw/3Qc4q="));
        System.out.println(StringUtils.upperCase(SecurityUtil.encryptMd5To32Str("SDK-SKY-010-01226985578","utf-8")));
