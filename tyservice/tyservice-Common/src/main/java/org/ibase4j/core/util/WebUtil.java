...
public final class WebUtil {
	...
	public static final String getCurrentUserSessionId() {
		try{
			Subject currentUser = SecurityUtils.getSubject();
			if (null != currentUser) {
				Session session = currentUser.getSession();
	 ...
	 * @return
	 */
	public static Map<String, Object> doMapPager(Map<String, Object> params) {
		int pageSize=15;//默认15条
		int pageNum=1;
		int start=0;
		int limit=0;
		int end=0;
