...
public final class DateUtil {
    ...
    public interface DATE_PATTERN {
        ...
        String YYYY_MM_DD_CN = "yyyy年 MM月 dd日";
    }
	 ...
	 * @return
	 */
	public static final String formatCN(Object date) {
		return format(date, DATE_PATTERN.YYYY_MM_DD_CN);
	}
	...
	public static void main(String[] args) {
		String date = formatCN(addDate(new Date(), Calendar.DATE, -11));
