...
//	private String password = "";
	 ...
	 * 构造函数175259202  
	 */
	public SmsClient(String serviceURL,String sn,String pwd)
			throws UnsupportedEncodingException {
		this.serviceURL = serviceURL;
		this.sn = sn;
		//this.password = password;
		//密码为md5(sn+password)
		this.pwd = pwd;//"2C3EF1F6C2A2D2A1AE696A3AA096604B";//this.getMD5(sn + password);
	}

	public static void main(String[] args) throws UnsupportedEncodingException{
		SmsClient c = new SmsClient("","","");
		System.out.println(c.getMD5("SDK-SKY-010-01520520044"));
	}
	/*
	 * 方法名称：getMD5 
	 * 功    能：字符串MD5加密 
