...
public class SysAuthorizeController extends BaseController {
	...
	@RequestMapping(value = "/sys/user/update/menu", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/sys/user/update/role", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/sys/role/update/menu", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/sys/cache/update", method = RequestMethod.POST)
